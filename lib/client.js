...
`;
        ...
        return h("div", { className: "dnb" },
          ...
          h("div", { className: "dnb-toolbar" },
            ...
            h("button", { className: "dnb-iconbtn run", disabled: nb.busy, title: t("tb_runAll_t"), onClick: function () { nb.call("runAll", {}, { pending: t("tp_runAll"), ok: t("tp_runAllOk") }); } }, t("tb_runAll")),
